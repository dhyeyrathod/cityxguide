...
class Admin extends CI_Model
{
	...
	{
		$sql_str = "SELECT city.id as id ,country.id as country_id, city.created_date , country.country_name as country_name , city_name FROM city INNER JOIN country ON city.fk_country_id = country.id";
		return $this->db->query($sql_str)->result();
	}
