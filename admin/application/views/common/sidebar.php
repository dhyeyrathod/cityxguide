<aside class="app-sidebar">
    ...
    <ul class="app-menu">
        ...
        <!-- <li>
            <a class="app-menu__item <?php if ($this->uri->segment(1) == "category") { echo "active" ; } ?>" href="<?= base_url('category') ?>"><i class="app-menu__icon fa fa-list-alt"></i><span class="app-menu__label">Category</span></a>
        </li>
